(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))o(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const n of i.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&o(n)}).observe(document,{childList:!0,subtree:!0});function a(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(s){if(s.ep)return;s.ep=!0;const i=a(s);fetch(s.href,i)}})();(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function t(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(o){if(o.ep)return;o.ep=!0;const s=t(o);fetch(o.href,s)}})();const Ze="/assets/capa-lisboa-ByYRjH84.jpeg",Ke="/assets/lisboa-ana-vitoria-CLOLizrS.mp3";let _=0,G=!1;const Ve=[],oe=10;let Se=!1;function et(){return`
    <!-- Navigation Dots -->
  ...
  `}function ke(){const e=document.querySelector("#app");e.innerHTML=et(),document.querySelectorAll(".slide").forEach(t=>{Ve.push(t)}),tt(),at(),kt(),ft(),ot(0)}function tt(){document.querySelectorAll(".nav-dot").forEach((e,t)=>{e.addEventListener("click",()=>{ge(t)})})}let N=null;function we(){const e=document.querySelector("nav");e&&window.innerWidth<768&&_>0&&_<oe-1&&(N&&(clearTimeout(N),N=null),e.style.opacity="1",e.style.pointerEvents="auto",N=setTimeout(()=>{e.style.opacity="0",e.style.pointerEvents="none"},2e3))}function at(){let e=0;function t(n){const l=document.getElementById("loveMessagesContainer"),d=document.getElementById("promisesContainer");return l&&(l.contains(n)||l===n)?l:d&&(d.contains(n)||d===n)?d:null}function a(n,l){if(!n||n.id==="loveMessagesContainer"&&!Se)return!1;const d=n.scrollTop<=0,m=n.scrollTop>=n.scrollHeight-n.clientHeight-1;return l==="down"?!m:!d}window.addEventListener("wheel",n=>{if(G)return;const l=t(n.target);if(l){const m=n.deltaY>0?"down":"up";if(a(l,m)){n.stopPropagation();return}const y=l.scrollTop<=0,h=l.scrollTop>=l.scrollHeight-l.clientHeight-1;if(m==="down"&&!h){n.stopPropagation();return}if(m==="up"&&!y){n.stopPropagation();return}}const d=Date.now();d-e<800||(e=d,we(),n.deltaY>0?Ce():Be())},{passive:!0});let o=0,s=0;document.addEventListener("touchstart",n=>{o=n.changedTouches[0].screenY,n.target},{passive:!0}),document.addEventListener("touchmove",n=>{const l=t(n.target);if(l){const d=o>n.changedTouches[0].screenY?"down":"up";if(a(l,d)){n.stopPropagation();return}}},{passive:!0}),document.addEventListener("touchend",n=>{s=n.changedTouches[0].screenY;const l=t(n.target);if(l){const d=o-s;if(Math.abs(d)>50){const m=d>0?"down":"up";if(a(l,m)){n.stopPropagation();return}const y=l.scrollTop<=0,h=l.scrollTop>=l.scrollHeight-l.clientHeight-1;if(m==="down"&&!h){n.stopPropagation();return}if(m==="up"&&!y){n.stopPropagation();return}}else{n.stopPropagation();return}}i()},{passive:!0});function i(){if(G)return;const n=o-s;Math.abs(n)>50&&(we(),n>0?Ce():Be())}window.addEventListener("keydown",n=>{G||(we(),n.key==="ArrowDown"||n.key==="PageDown"?Ce():(n.key==="ArrowUp"||n.key==="PageUp")&&Be())})}function Ce(){_<oe-1&&ge(_+1)}function Be(){_>0&&ge(_-1)}function ge(e){if(G||e===_)return;if(_===9&&e!==9){J&&(clearTimeout(J),J=null),fe=!1;const o=document.getElementById("finalMessageText");o&&(o.textContent="")}if(_===4&&e!==4){const o=document.getElementById("musicAudioPlayer");if(o&&!o.paused){o.pause(),o.currentTime=0,o.volume=1,se=!1,Ge();const s=document.getElementById("playPauseBtn");if(s){const l=s.querySelector(".play-icon"),d=s.querySelector(".pause-icon");l&&l.classList.remove("hidden"),d&&d.classList.add("hidden")}const i=document.getElementById("musicIntroText"),n=document.getElementById("musicPlayerContainer");i&&(i.style.opacity="0"),n&&(n.style.opacity="0",n.style.transform="translateY(32px)")}}G=!0,_=e,Ve.forEach((o,s)=>{s===e?(o.classList.add("active"),o.classList.remove("prev","next")):s<e?(o.classList.remove("active","next"),o.classList.add("prev")):(o.classList.remove("active","prev"),o.classList.add("next"))}),document.querySelectorAll(".nav-dot").forEach((o,s)=>{s===e?o.classList.add("active"):o.classList.remove("active")});const t=document.querySelector("nav");t&&window.innerWidth<768&&(N&&(clearTimeout(N),N=null),e===0||e===oe-1?(t.style.opacity="1",t.style.pointerEvents="auto"):(t.style.opacity="1",t.style.pointerEvents="auto",N=setTimeout(()=>{t.style.opacity="0",t.style.pointerEvents="none"},2e3))),Ye(e);const a=document.getElementById("scrollIndicator");a&&(e===oe-1?(a.classList.add("opacity-0"),a.classList.remove("opacity-100")):(a.classList.add("opacity-100"),a.classList.remove("opacity-0"))),setTimeout(()=>{G=!1},1e3)}function ot(e){ge(e)}function Ye(e){switch(e){case 0:st();break;case 1:nt();break;case 2:yt(),Oe();break;case 3:it();break;case 4:vt();break;case 5:Et();break;case 6:St();break;case 7:Tt();break;case 8:At();break;case 9:_t();break}}function st(){document.querySelectorAll(".message-bubble").forEach((e,t)=>{setTimeout(()=>{e.classList.add("show")},t*1500)})}function nt(){document.querySelectorAll(".floating-hearts .heart").forEach((e,t)=>{setTimeout(()=>{e.style.animation="floatUp 4s ease-in-out infinite",e.style.animationDelay=`${t*.3}s`},100)})}function it(){const e=document.getElementById("loveTitle"),t=document.getElementById("loveMessagesContainer");if(!e||!t)return;Se=!1,t.style.overflow="hidden",t.style.pointerEvents="none",t.innerHTML="",t.style.opacity="0",e.style.opacity="1",e.style.transition="opacity 1s ease-out";const a=[{text:"Meu amor, sinceramente eu não tenho palavras pra expressar o quanto sou grata por você ter aparecido na minha vida. Sério, sei que já falei isso outras vezes kkkkk, mas é que apesar do pouco tempo que a gente tem de contato, parece que eu te conheço há muito mais tempo.",sender:"her",delay:500},{text:"Pode até parecer cedo pelo que vou dizer agora, e espero de coração que não te incomode ou soe precipitado...",sender:"her",delay:4e3},{text:"Mas eu te amo. Muito. ❤",sender:"her",delay:3e3},{text:"Kkkkk em que mundo vc ouvir da mulher que vc é completamente apaixonado que ela te ama pode se tornar algo que ruim, algo que incomode, não tem como kkk",sender:"him",delay:5e3},{text:"Eu sou mt sentimento e conexão, e eu nunca senti algo tão forte por alguém em tão pouco tempo como eu sinto por vc, de fato parece que a gnt se conhece a anos, parece que já vivemos tanto, que nos conhecemos tanto, as vezes parece um sonho, parece que a qualquer momento eu vou acordar com o despertador tocando e perceber que td isso só aconteceu na minha mente",sender:"him",delay:6e3},{text:"como eu disse eu sou sentimento e sinto por vc desde o primeiro olhar que a gnt trocou, eu já sei que te amo desde o primeiro dia que nos vimos e eu posso provar kk eu já sei que te amo desde o primeiro sorriso que eu vi de perto, já sei que te amo desde a primeira vez que olhei no fundo dos seus olhos e vi quem vc é",sender:"him",delay:6e3},{text:"eu não queria te assustar, ia tentar aguentar pelo menos até o pedido, mas que bom que não preciso mais segurar isso…",sender:"him",delay:4e3},{text:"Eu amo você minha linda 💜",sender:"him",delay:3e3}];let o=0;a.forEach(s=>{o+=s.delay}),setTimeout(()=>{e.style.opacity="0",e.style.transition="opacity 1s ease-out",setTimeout(()=>{t.style.opacity="1",t.style.transition="opacity 1s ease-in";const s=[];a.forEach(n=>{const l=document.createElement("div");l.className=`message-bubble ${n.sender==="her"?"bg-[#e1ffc7] text-[#000] self-start":"bg-[#1a6a5c] text-white self-end"} opacity-0`,l.style.transition="opacity 0.5s ease-in, transform 0.5s ease-out",l.style.transform="translateY(10px)";const d=document.createElement("p");d.className="text-base md:text-lg leading-relaxed",d.textContent=n.text,l.appendChild(d),t.appendChild(l),s.push(l)});let i=0;s.forEach((n,l)=>{i+=a[l].delay,setTimeout(()=>{n.style.opacity="1",n.style.transform="translateY(0)",setTimeout(()=>{const d=n.getBoundingClientRect(),m=t.getBoundingClientRect();(d.bottom>m.bottom||d.top<m.top)&&n.scrollIntoView({behavior:"smooth",block:"nearest"})},200),l===s.length-1&&setTimeout(()=>{Se=!0,t.style.overflow="auto",t.style.pointerEvents="auto"},500)},i)})},1e3)},3e3)}let L={date:"2025-06-25",city:"São Paulo",latitude:-23.5505,longitude:-46.6333,time:"20:00"};const lt=[{name:"Sirius",ra:101.287,dec:-16.716,mag:-1.46},{name:"Canopus",ra:95.988,dec:-52.696,mag:-.74},{name:"Arcturus",ra:213.915,dec:19.182,mag:-.05},{name:"Vega",ra:279.235,dec:38.784,mag:.03},{name:"Capella",ra:79.172,dec:45.998,mag:.08},{name:"Rigel",ra:78.634,dec:-8.202,mag:.13},{name:"Procyon",ra:114.825,dec:5.225,mag:.34},{name:"Betelgeuse",ra:88.793,dec:7.407,mag:.45},{name:"Achernar",ra:24.429,dec:-57.237,mag:.46},{name:"Hadar",ra:210.956,dec:-60.373,mag:.61},{name:"Altair",ra:297.695,dec:8.868,mag:.76},{name:"Aldebaran",ra:68.98,dec:16.509,mag:.87},{name:"Antares",ra:247.352,dec:-26.432,mag:.96},{name:"Spica",ra:201.298,dec:-11.161,mag:.98},{name:"Pollux",ra:116.329,dec:28.026,mag:1.14},{name:"Fomalhaut",ra:344.413,dec:-29.622,mag:1.16},{name:"Deneb",ra:310.358,dec:45.28,mag:1.25},{name:"Mimosa",ra:191.93,dec:-59.689,mag:1.25},{name:"Regulus",ra:152.093,dec:11.967,mag:1.36},{name:"Adhara",ra:104.656,dec:-28.972,mag:1.5}],qe={Órion:{stars:["Rigel","Betelgeuse","Aldebaran"],connections:[["Rigel","Betelgeuse"],["Betelgeuse","Aldebaran"]],meaning:"Órion, o Caçador, é uma das constelações mais reconhecidas. Na mitologia, representa força e determinação. Ver Órion no céu simboliza novos começos e a busca por seus objetivos com coragem.",season:"inverno"},"Triângulo de Verão":{stars:["Vega","Altair","Deneb"],connections:[["Vega","Altair"],["Altair","Deneb"],["Deneb","Vega"]],meaning:"O Triângulo de Verão é formado por três das estrelas mais brilhantes do céu. Representa harmonia, equilíbrio e a conexão entre diferentes pontos que formam algo maior e mais belo.",season:"verão"},"Cão Maior":{stars:["Sirius","Adhara"],connections:[["Sirius","Adhara"]],meaning:"Cão Maior abriga Sirius, a estrela mais brilhante do céu. Simboliza lealdade, proteção e a luz que guia nos momentos mais escuros. Ver Sirius é um sinal de esperança e direção.",season:"inverno"},"Cão Menor":{stars:["Procyon"],connections:[],meaning:"Cão Menor, com Procyon, representa companheirismo e fidelidade. É a constelação que acompanha Órion, simbolizando que não estamos sozinhos em nossa jornada.",season:"inverno"},Boiadeiro:{stars:["Arcturus"],connections:[],meaning:"Boiadeiro, com Arcturus, representa proteção e cuidado. Na mitologia, é o guardião que vigia e protege. Ver Arcturus no céu simboliza segurança e estabilidade.",season:"primavera"},Escorpião:{stars:["Antares"],connections:[],meaning:"Escorpião, com Antares (a estrela rival de Marte), representa transformação e renovação. Simboliza a capacidade de superar desafios e renascer mais forte.",season:"verão"},Leão:{stars:["Regulus"],connections:[],meaning:"Leão, com Regulus (o coração do leão), representa coragem, liderança e nobreza. Ver Regulus no céu simboliza força interior e a coragem de seguir seu coração.",season:"primavera"},Virgem:{stars:["Spica"],connections:[],meaning:"Virgem, com Spica, representa pureza, sabedoria e crescimento. Simboliza novos começos e o florescimento de algo belo e promissor.",season:"primavera"},Cisne:{stars:["Deneb"],connections:[],meaning:"Cisne, com Deneb, representa transformação e elevação. Na mitologia, o cisne voa alto e livre, simbolizando a capacidade de superar limitações e alcançar novos horizontes.",season:"verão"},Águia:{stars:["Altair"],connections:[],meaning:"Águia, com Altair, representa visão clara, liberdade e perspectiva elevada. Simboliza a capacidade de ver além e encontrar o caminho certo.",season:"verão"},Lira:{stars:["Vega"],connections:[],meaning:"Lira, com Vega, representa música, harmonia e arte. Na mitologia, é o instrumento de Orfeu, simbolizando o poder da música e da beleza para tocar corações.",season:"verão"}};async function _e(e,t,a){try{const o=new Date(a),s=new Date;s.setHours(0,0,0,0),o.setHours(0,0,0,0);const i=a.split("T")[0];if(o<s)try{const n=await fetch(`https://archive-api.open-meteo.com/v1/archive?latitude=${e}&longitude=${t}&start_date=${i}&end_date=${i}&daily=weather_code,temperature_2m_max,temperature_2m_min&timezone=auto`);if(n.ok){const l=await n.json();if(l.daily&&l.daily.weather_code&&l.daily.weather_code.length>0){const d=l.daily.weather_code[0],m=l.daily.temperature_2m_max[0],y=l.daily.temperature_2m_min[0],h=Math.round((m+y)/2),g=Fe(d),u=De(d);return{temperature:h,description:u,icon:$e(g),condition:g}}}}catch(n){console.warn("Erro ao buscar dados históricos, usando estimativa:",n)}else try{const n=await fetch(`https://api.open-meteo.com/v1/forecast?latitude=${e}&longitude=${t}&daily=weather_code,temperature_2m_max,temperature_2m_min&timezone=auto&forecast_days=1`);if(n.ok){const l=await n.json();if(l.daily&&l.daily.weather_code&&l.daily.weather_code.length>0){const d=l.daily.weather_code[0],m=l.daily.temperature_2m_max[0],y=l.daily.temperature_2m_min[0],h=Math.round((m+y)/2),g=Fe(d),u=De(d);return{temperature:h,description:u,icon:$e(g),condition:g}}}}catch(n){console.warn("Erro ao buscar previsão, usando estimativa:",n)}return Ie(e,a)}catch(o){return console.error("Erro ao buscar dados do clima:",o),Ie(e,a)}}function Fe(e){return e===0?"Clear":e>=1&&e<=3||e>=45&&e<=48?"Clouds":e>=51&&e<=67?"Rain":e>=71&&e<=77?"Snow":e>=80&&e<=99?"Rain":"Clouds"}function De(e){return e===0?"céu limpo":e>=1&&e<=3?"parcialmente nublado":e>=45&&e<=48?"névoa":e>=51&&e<=55?"garoa":e>=56&&e<=57?"garoa congelante":e>=61&&e<=67?"chuva":e>=71&&e<=77?"neve":e>=80&&e<=82?"aguaceiros":e>=85&&e<=86?"neve":e>=95&&e<=99?"trovoada":"variável"}function $e(e){return e==="Clear"?"01d":e==="Clouds"?"02d":e==="Rain"?"10d":e==="Snow"?"13d":"02d"}function Ie(e,t){const a=new Date(t).getMonth()+1;let o=20;e>-15?o=28:e>-23?o=22:o=18;const s=o+({1:3,2:2,3:0,4:-2,5:-4,6:-5,7:-4,8:-2,9:0,10:2,11:3,12:3}[a]||0);let i="Clear",n="céu limpo";if(a>=6&&a<=8)i=Math.random()>.3?"Clear":"Clouds",n=i==="Clear"?"céu limpo":"parcialmente nublado";else{const l=Math.random();l>.6?(i="Clear",n="céu limpo"):l>.3?(i="Clouds",n="parcialmente nublado"):(i="Rain",n="chuva")}return{temperature:Math.round(s),description:n,icon:i==="Clear"?"01d":i==="Clouds"?"02d":"10d",condition:i}}function rt(e,t){const[a,o]=e.split(":").map(Number),s=a+o/60;let i="night";return s>=5&&s<7?i="dawn":s>=7&&s<18?i="day":s>=18&&s<20&&(i="dusk"),{night:{base:"#0a0a1a",gradient:[{stop:0,color:"rgba(138, 43, 226, 0.1)"},{stop:1,color:"rgba(0, 0, 0, 0.9)"}],starsVisible:!0},dawn:{base:t==="Clear"?"#1a1a3e":"#2a2a4e",gradient:t==="Clear"?[{stop:0,color:"rgba(255, 140, 0, 0.3)"},{stop:.5,color:"rgba(255, 200, 100, 0.2)"},{stop:1,color:"rgba(50, 50, 100, 0.8)"}]:[{stop:0,color:"rgba(150, 150, 180, 0.4)"},{stop:1,color:"rgba(50, 50, 80, 0.9)"}],starsVisible:s<6},day:{base:t==="Clear"?"#87CEEB":t==="Clouds"?"#B0C4DE":"#708090",gradient:t==="Clear"?[{stop:0,color:"rgba(135, 206, 250, 0.8)"},{stop:.3,color:"rgba(173, 216, 230, 0.6)"},{stop:1,color:"rgba(70, 130, 180, 0.4)"}]:t==="Clouds"?[{stop:0,color:"rgba(176, 196, 222, 0.7)"},{stop:1,color:"rgba(105, 105, 105, 0.5)"}]:[{stop:0,color:"rgba(112, 128, 144, 0.8)"},{stop:1,color:"rgba(70, 70, 70, 0.6)"}],starsVisible:!1},dusk:{base:t==="Clear"?"#2a1a3e":"#3a2a4e",gradient:t==="Clear"?[{stop:0,color:"rgba(255, 69, 0, 0.4)"},{stop:.3,color:"rgba(255, 140, 0, 0.3)"},{stop:.7,color:"rgba(138, 43, 226, 0.2)"},{stop:1,color:"rgba(0, 0, 0, 0.8)"}]:[{stop:0,color:"rgba(150, 120, 150, 0.4)"},{stop:1,color:"rgba(50, 50, 80, 0.9)"}],starsVisible:s>19}}[i]}function dt(e,t,a,o){const s=(o-7)/10,i=t*.15+t*.7*s,n=a*.25,l=60,d=l*2.5,m=e.createRadialGradient(i,n,0,i,n,d);m.addColorStop(0,"rgba(255, 255, 200, 0.8)"),m.addColorStop(.3,"rgba(255, 200, 100, 0.6)"),m.addColorStop(.6,"rgba(255, 150, 50, 0.3)"),m.addColorStop(1,"rgba(255, 100, 0, 0)"),e.fillStyle=m,e.beginPath(),e.arc(i,n,d,0,Math.PI*2),e.fill();const y=e.createRadialGradient(i,n,0,i,n,l);y.addColorStop(0,"#FFD700"),y.addColorStop(.7,"#FFA500"),y.addColorStop(1,"#FF8C00"),e.fillStyle=y,e.beginPath(),e.arc(i,n,l,0,Math.PI*2),e.fill(),e.fillStyle="rgba(255, 255, 255, 0.6)",e.beginPath(),e.arc(i,n,l*.6,0,Math.PI*2),e.fill()}let Me=0;function Ee(e,t,a){Me+=.3,e.save();const o=200,s=8;for(let i=0;i<o;i++){const n=t/o*i,l=Me*s*(1+i%3)%t,d=n+l,m=-20+i%5*30,y=Me*s*(1+i%3)%(a+40),h=m+y,g=15+i%3*5,u=.6+i%2*.2;e.strokeStyle=`rgba(173, 216, 230, ${u})`,e.lineWidth=2,e.beginPath(),e.moveTo(d,h),e.lineTo(d,h+g),e.stroke()}e.restore()}let K=0,me=null;function Re(e,t,a,o,s=!1){me===null&&(me=Date.now()),K+=.08;const i=o==="Clouds"?6:o==="Rain"?10:3,n=o==="Clouds"?.7:o==="Rain"?.85:.4;if(s){const[y,h]=L.time.split(":").map(Number),g=y+h/60,u=g>=7&&g<15.5,b=g>=15.5&&g<18,E=g>=18&&g<20,S=(q==null?void 0:q.weatherCondition)||o;if(u||b||E){const c=e.createLinearGradient(0,0,0,a);if(u)S==="Clear"?(c.addColorStop(0,"#87CEEB"),c.addColorStop(.5,"#87CEEB"),c.addColorStop(.8,"#B0D4E6"),c.addColorStop(1,"#C8E0F0")):S==="Clouds"?(c.addColorStop(0,"#B0C4DE"),c.addColorStop(.5,"#B8C8E0"),c.addColorStop(.8,"#C0D0E0"),c.addColorStop(1,"#C8D8E8")):(c.addColorStop(0,"#708090"),c.addColorStop(.5,"#788898"),c.addColorStop(.8,"#8898A8"),c.addColorStop(1,"#98A8B8"));else if(b){const x=(g-15.5)/2.5,v=(M,z,A)=>{const k=M.replace("#",""),I=z.replace("#",""),F=parseInt(k.substr(0,2),16),r=parseInt(k.substr(2,2),16),p=parseInt(k.substr(4,2),16),f=parseInt(I.substr(0,2),16),w=parseInt(I.substr(2,2),16),T=parseInt(I.substr(4,2),16),B=Math.round(F+(f-F)*A),C=Math.round(r+(w-r)*A),P=Math.round(p+(T-p)*A);return`#${B.toString(16).padStart(2,"0")}${C.toString(16).padStart(2,"0")}${P.toString(16).padStart(2,"0")}`};S==="Clear"?(c.addColorStop(0,v("#87CEEB","#FF8C42",x)),c.addColorStop(.5,v("#B0D4E6","#FF7F50",x)),c.addColorStop(.8,v("#B0D4E6","#FF6347",x)),c.addColorStop(1,v("#C8E0F0","#FF6B6B",x))):S==="Clouds"?(c.addColorStop(0,v("#B0C4DE","#FFA07A",x)),c.addColorStop(.5,v("#B8C8E0","#FF8C69",x)),c.addColorStop(.8,v("#C0D0E0","#A0522D",x)),c.addColorStop(1,v("#C8D8E8","#CD5C5C",x))):(c.addColorStop(0,v("#708090","#D2691E",x)),c.addColorStop(.5,v("#788898","#CD853F",x)),c.addColorStop(.8,v("#8898A8","#8B4513",x)),c.addColorStop(1,v("#98A8B8","#A0522D",x)))}else E&&(S==="Clear"?(c.addColorStop(0,"#FF8C42"),c.addColorStop(.2,"#FF7F50"),c.addColorStop(.4,"#FF6B6B"),c.addColorStop(.6,"#FF6347"),c.addColorStop(.75,"#FF4500"),c.addColorStop(.85,"#DC143C"),c.addColorStop(.95,"#8B0000"),c.addColorStop(1,"#6B0000")):S==="Clouds"?(c.addColorStop(0,"#FFA07A"),c.addColorStop(.3,"#FF8C69"),c.addColorStop(.5,"#CD5C5C"),c.addColorStop(.7,"#A0522D"),c.addColorStop(.85,"#8B4513"),c.addColorStop(1,"#654321")):(c.addColorStop(0,"#D2691E"),c.addColorStop(.3,"#CD853F"),c.addColorStop(.5,"#A0522D"),c.addColorStop(.7,"#8B4513"),c.addColorStop(.85,"#654321"),c.addColorStop(1,"#4B2C1A")));e.fillStyle=c,e.fillRect(0,0,t,a)}}const l=Date.now()-me,d=2e3,m=Math.min(1,l/d);for(let y=0;y<i;y++){const h=t/(i+1)*(y+1),g=5+y%3*3,u=K*g%(t+300)-150,b=h+u,E=a*(.12+y%4*.12),S=Math.sin(K*.05+y*.5)*15,c=Math.max(0,Math.min(a*.6,E+S)),x=Math.sin(K*.03+y)*15,v=100+y%3*50,M=Math.max(60,Math.min(200,v+x)),z=.9+Math.sin(K*.05+y)*.1,A=n*z,k=y*200/d,I=Math.max(0,Math.min(1,(m-k)/(1-k))),F=Math.max(0,Math.min(1,A*I));e.save(),ct(e,b,c,M,F),e.restore()}}function ct(e,t,a,o,s){e.save(),e.globalAlpha=s;const i=e.createRadialGradient(t,a-o*.2,0,t,a,o);i.addColorStop(0,`rgba(255, 255, 255, ${s*.95})`),i.addColorStop(.5,`rgba(255, 255, 255, ${s*.8})`),i.addColorStop(1,`rgba(240, 240, 250, ${s*.6})`),[{x:t,y:a,r:o*.65},{x:t-o*.45,y:a,r:o*.55},{x:t+o*.45,y:a,r:o*.55},{x:t-o*.25,y:a-o*.25,r:o*.5},{x:t+o*.25,y:a-o*.25,r:o*.5},{x:t,y:a-o*.3,r:o*.45},{x:t-o*.35,y:a+o*.15,r:o*.4},{x:t+o*.35,y:a+o*.15,r:o*.4},{x:t-o*.6,y:a-o*.1,r:o*.35},{x:t+o*.6,y:a-o*.1,r:o*.35}].forEach((n,l)=>{const d=e.createRadialGradient(n.x,n.y-n.r*.3,0,n.x,n.y,n.r);d.addColorStop(0,`rgba(255, 255, 255, ${s*.9})`),d.addColorStop(.6,`rgba(255, 255, 255, ${s*.7})`),d.addColorStop(1,`rgba(240, 240, 250, ${s*.4})`),e.fillStyle=d,e.beginPath(),e.arc(n.x,n.y,n.r,0,Math.PI*2),e.fill()}),e.fillStyle=`rgba(200, 200, 220, ${s*.2})`,e.beginPath(),e.ellipse(t,a+o*.3,o*.7,o*.2,0,0,Math.PI*2),e.fill(),e.restore()}function mt(e){const[t,a,o]=e.split("-").map(Number);return a===12||a===1||a===2?"verão":a===3||a===4||a===5?"outono":a===6||a===7||a===8?"inverno":a===9||a===10||a===11?"primavera":"verão"}function ut(e,t){const a={},o=mt(t);Object.keys(qe).forEach(n=>{const l=qe[n];let d=0,m=0;l.stars.forEach(y=>{const h=e.find(g=>g.name===y);h&&(m++,d+=(2-h.mag)*10)}),m===l.stars.length&&l.stars.length>0&&(d+=50),l.connections.length>0&&(d+=30),l.season===o?d+=100:d*=.3,m>0&&(a[n]={score:d,visibleCount:m,totalStars:l.stars.length,constellation:l})});let s=0,i=null;return Object.keys(a).forEach(n=>{a[n].score>s&&(s=a[n].score,i=n)}),i?{name:i,...a[i]}:null}function Ne(e){const[t,a,o]=e.split("-").map(Number);return`${o.toString().padStart(2,"0")}/${a.toString().padStart(2,"0")}/${t}`}const He={"são paulo":{lat:-23.5505,lon:-46.6333,name:"São Paulo, SP, Brasil"},"sao paulo":{lat:-23.5505,lon:-46.6333,name:"São Paulo, SP, Brasil"},"rio de janeiro":{lat:-22.9068,lon:-43.1729,name:"Rio de Janeiro, RJ, Brasil"},rio:{lat:-22.9068,lon:-43.1729,name:"Rio de Janeiro, RJ, Brasil"},"belo horizonte":{lat:-19.9167,lon:-43.9345,name:"Belo Horizonte, MG, Brasil"},brasília:{lat:-15.7942,lon:-47.8822,name:"Brasília, DF, Brasil"},brasilia:{lat:-15.7942,lon:-47.8822,name:"Brasília, DF, Brasil"},salvador:{lat:-12.9714,lon:-38.5014,name:"Salvador, BA, Brasil"},curitiba:{lat:-25.4284,lon:-49.2733,name:"Curitiba, PR, Brasil"},fortaleza:{lat:-3.7172,lon:-38.5433,name:"Fortaleza, CE, Brasil"},recife:{lat:-8.0476,lon:-34.877,name:"Recife, PE, Brasil"},"porto alegre":{lat:-30.0346,lon:-51.2177,name:"Porto Alegre, RS, Brasil"},manaus:{lat:-3.119,lon:-60.0217,name:"Manaus, AM, Brasil"},belém:{lat:-1.4558,lon:-48.5044,name:"Belém, PA, Brasil"},belem:{lat:-1.4558,lon:-48.5044,name:"Belém, PA, Brasil"},goiânia:{lat:-16.6864,lon:-49.2643,name:"Goiânia, GO, Brasil"},goiania:{lat:-16.6864,lon:-49.2643,name:"Goiânia, GO, Brasil"},guarulhos:{lat:-23.4538,lon:-46.5331,name:"Guarulhos, SP, Brasil"},campinas:{lat:-22.9056,lon:-47.0608,name:"Campinas, SP, Brasil"},"são luís":{lat:-2.5387,lon:-44.2825,name:"São Luís, MA, Brasil"},"sao luis":{lat:-2.5387,lon:-44.2825,name:"São Luís, MA, Brasil"},maceió:{lat:-9.5713,lon:-36.782,name:"Maceió, AL, Brasil"},maceio:{lat:-9.5713,lon:-36.782,name:"Maceió, AL, Brasil"},natal:{lat:-5.7945,lon:-35.211,name:"Natal, RN, Brasil"},teresina:{lat:-5.0892,lon:-42.8019,name:"Teresina, PI, Brasil"},aracaju:{lat:-10.9091,lon:-37.0677,name:"Aracaju, SE, Brasil"},florianópolis:{lat:-27.5954,lon:-48.548,name:"Florianópolis, SC, Brasil"},florianopolis:{lat:-27.5954,lon:-48.548,name:"Florianópolis, SC, Brasil"},vitória:{lat:-20.3155,lon:-40.3128,name:"Vitória, ES, Brasil"},vitoria:{lat:-20.3155,lon:-40.3128,name:"Vitória, ES, Brasil"},"joão pessoa":{lat:-7.115,lon:-34.8611,name:"João Pessoa, PB, Brasil"},"joao pessoa":{lat:-7.115,lon:-34.8611,name:"João Pessoa, PB, Brasil"},cuiabá:{lat:-15.6014,lon:-56.0979,name:"Cuiabá, MT, Brasil"},cuiaba:{lat:-15.6014,lon:-56.0979,name:"Cuiabá, MT, Brasil"},"campo grande":{lat:-20.4697,lon:-54.6201,name:"Campo Grande, MS, Brasil"},"porto velho":{lat:-8.7619,lon:-63.9039,name:"Porto Velho, RO, Brasil"},"boa vista":{lat:2.8235,lon:-60.6758,name:"Boa Vista, RR, Brasil"},"rio branco":{lat:-9.9747,lon:-67.81,name:"Rio Branco, AC, Brasil"},macapá:{lat:.0349,lon:-51.0664,name:"Macapá, AP, Brasil"},macapa:{lat:.0349,lon:-51.0664,name:"Macapá, AP, Brasil"},palmas:{lat:-10.1844,lon:-48.3336,name:"Palmas, TO, Brasil"}};async function pt(e){try{const t=document.getElementById("starMapLoading");t&&(t.style.display="block");const a=e.toLowerCase().trim();if(He[a]){const o=He[a];return t&&(t.style.display="none"),{latitude:o.lat,longitude:o.lon,displayName:o.name}}try{const o=`https://api.allorigins.win/get?url=${encodeURIComponent(`https://nominatim.openstreetmap.org/search?format=json&q=${encodeURIComponent(e)}&limit=1`)}`,s=await fetch(o,{method:"GET",headers:{Accept:"application/json"}});if(!s.ok)throw new Error("API não disponível");const i=await s.json(),n=JSON.parse(i.contents);if(t&&(t.style.display="none"),n&&n.length>0)return{latitude:parseFloat(n[0].lat),longitude:parseFloat(n[0].lon),displayName:n[0].display_name}}catch(o){console.warn("API de geocodificação não disponível, usando fallback:",o)}return t&&(t.style.display="none"),console.warn(`Cidade "${e}" não encontrada, usando coordenadas padrão (São Paulo)`),{latitude:-23.5505,longitude:-46.6333,displayName:"São Paulo, SP, Brasil (padrão)"}}catch(t){const a=document.getElementById("starMapLoading");return a&&(a.style.display="none"),console.error("Erro ao buscar coordenadas:",t),{latitude:-23.5505,longitude:-46.6333,displayName:"São Paulo, SP, Brasil (padrão)"}}}let Y=null;function Le(){const e=document.getElementById("starMapInfoMobile"),t=document.getElementById("starMapInfoToggle"),a=document.getElementById("starMapInfoCloseBtn");Y&&(document.removeEventListener("click",Y,!0),Y=null),e&&(e.style.transition="transform 0.4s cubic-bezier(0.4, 0, 0.2, 1)",e.offsetWidth,e.classList.remove("translate-x-0"),e.classList.add("translate-x-full")),a&&(a.style.transition="opacity 0.3s ease-out",a.style.opacity="0",a.style.pointerEvents="none"),setTimeout(()=>{t&&(t.style.display="block",t.style.opacity="0",setTimeout(()=>{t.style.transition="opacity 0.3s ease-in",t.style.opacity="1"},50))},400)}function ft(){const e=document.getElementById("starMapForm"),t=document.getElementById("starMapFormMobileForm"),a=document.getElementById("starMapToggleBtn"),o=document.getElementById("starMapToggleIcon"),s=document.getElementById("starMapFormMobile"),i=document.getElementById("starMapInfoMobile"),n=document.getElementById("starMapInfoToggle");if(a&&s&&o){let u=!1;a.addEventListener("click",()=>{u=!u,u?(s.classList.remove("scale-0","opacity-0"),s.classList.add("scale-100","opacity-100"),o.style.transition="transform 0.3s ease-in-out",o.textContent="+",setTimeout(()=>{o.style.transform="rotate(45deg)",setTimeout(()=>{o.textContent="×",o.style.transform="rotate(0deg)"},150)},10)):(s.classList.remove("scale-100","opacity-100"),s.classList.add("scale-0","opacity-0"),o.style.transition="transform 0.3s ease-in-out",o.textContent="×",setTimeout(()=>{o.style.transform="rotate(45deg)",setTimeout(()=>{o.textContent="+",o.style.transform="rotate(0deg)"},150)},10))})}n&&i&&n.addEventListener("click",()=>{if(i.classList.contains("translate-x-full")){i.style.transition="transform 0.4s cubic-bezier(0.4, 0, 0.2, 1)",i.classList.remove("translate-x-full"),i.classList.add("translate-x-0"),n.style.display="none";const u=document.getElementById("starMapInfoCloseBtn");u&&(u.style.opacity="1",u.style.pointerEvents="auto"),setTimeout(()=>{Y&&document.removeEventListener("click",Y,!0),Y=b=>{var E;if(!i.classList.contains("translate-x-0"))return;const S=b.target,c=i.contains(S),x=(E=document.getElementById("starMapInfoCloseBtn"))==null?void 0:E.contains(S),v=n==null?void 0:n.contains(S);!c&&!x&&!v&&window.innerWidth<768&&(b.stopPropagation(),Le())},document.addEventListener("click",Y,!0)},400)}});const l=document.getElementById("starMapDate"),d=document.getElementById("starMapTime"),m=document.getElementById("starMapCity"),y=document.getElementById("starMapUpdateBtn"),h=document.getElementById("starMapLoading");if(document.getElementById("starMapUpdateBtnMobile"),document.getElementById("starMapLoadingMobile"),!e||!l||!d||!m||!y)return;l.addEventListener("click",u=>{var b;u.stopPropagation(),(b=l.showPicker)==null||b.call(l)}),l.addEventListener("focus",()=>{var u;(u=l.showPicker)==null||u.call(l)}),d.addEventListener("click",u=>{var b;u.stopPropagation(),(b=d.showPicker)==null||b.call(d)}),d.addEventListener("focus",()=>{var u;(u=d.showPicker)==null||u.call(d)});const g=async(u,b=!1)=>{u.preventDefault();const E=b?document.getElementById("starMapDateMobile"):null,S=b?document.getElementById("starMapTimeMobile"):null,c=b?document.getElementById("starMapCityMobile"):null,x=b?document.getElementById("starMapUpdateBtnMobile"):null,v=b?document.getElementById("starMapLoadingMobile"):null,M=b?E:l,z=b?S:d,A=b?c:m,k=b?x:y,I=b?v:h;if(!M||!z||!A||!k)return;const F=A.value.trim(),r=M.value,p=z.value;if(b)l&&(l.value=r),d&&(d.value=p),m&&(m.value=F);else{const w=document.getElementById("starMapDateMobile"),T=document.getElementById("starMapTimeMobile"),B=document.getElementById("starMapCityMobile");w&&(w.value=r),T&&(T.value=p),B&&(B.value=F)}if(!F){A.setCustomValidity("Por favor, insira o nome da cidade"),A.reportValidity();return}if(A.setCustomValidity(""),!r){M.setCustomValidity("Por favor, selecione uma data"),M.reportValidity();return}M.setCustomValidity(""),k.disabled=!0,k.setAttribute("aria-busy","true"),I&&(I.classList.remove("hidden"),I.textContent="Buscando coordenadas...");const f=k.querySelector(".star-map-button-icon");f&&(f.textContent="⏳");try{const w=await pt(F);L={date:r,city:F,latitude:w.latitude,longitude:w.longitude,time:p||"20:00"},gt(),setTimeout(()=>{Oe(!0),b&&s&&setTimeout(()=>{s.classList.remove("scale-100","opacity-100"),s.classList.add("scale-0","opacity-0"),o&&(o.textContent="+",o.style.transform="rotate(0deg)")},1e3)},500),R&&clearTimeout(R),R=setTimeout(()=>{ht()},5e3),f&&(f.textContent="✓"),I&&(w.displayName&&w.displayName.includes("padrão")?I.textContent="Cidade não encontrada. Usando coordenadas padrão.":I.textContent="Céu atualizado com sucesso!",I.classList.remove("hidden")),setTimeout(()=>{f&&(f.textContent="✨"),I&&I.classList.add("hidden")},2e3)}catch(w){console.error("Erro ao processar formulário:",w),f&&(f.textContent="⚠️"),I&&(I.textContent="Erro ao processar. Tente novamente.",I.classList.remove("hidden")),setTimeout(()=>{f&&(f.textContent="✨"),I&&I.classList.add("hidden")},3e3)("Erro ao atualizar mapa estelar:",w),f&&(f.textContent="⚠️"),I&&(I.textContent="Erro ao processar. Tente novamente.",I.classList.remove("hidden")),setTimeout(()=>{f&&(f.textContent="✨"),I&&I.classList.add("hidden")},3e3)}finally{k.disabled=!1,k.setAttribute("aria-busy","false")}};e.addEventListener("submit",u=>g(u,!1)),t&&t.addEventListener("submit",u=>g(u,!0))}let R=null,j=null,ee=null,q=null;function gt(){const e=document.getElementById("starMapText"),t=document.getElementById("starMapControls");R&&(clearTimeout(R),R=null),e&&(e.classList.add("opacity-0","-translate-y-5"),e.classList.remove("opacity-100","translate-y-0"),setTimeout(()=>{e.classList.add("hidden")},1e3)),t&&(t.classList.add("opacity-0","translate-y-5"),t.classList.remove("opacity-100","translate-y-0"),setTimeout(()=>{t.classList.add("hidden")},1e3));const a=document.getElementById("starMapCanvas");a&&a.classList.add("star-map-highlighted")}function ht(){const e=document.getElementById("starMapControls");e&&(e.classList.remove("hidden"),e.classList.add("opacity-0","translate-y-5"),e.classList.remove("opacity-100","translate-y-0"),setTimeout(()=>{e.classList.remove("opacity-0","translate-y-5"),e.classList.add("opacity-100","translate-y-0")},50))}function yt(){const e=document.getElementById("starMapText"),t=document.getElementById("starMapControls"),a=document.getElementById("starMapCanvas");R&&(clearTimeout(R),R=null),e&&(e.classList.remove("hidden"),e.classList.add("opacity-0","-translate-y-5"),e.classList.remove("opacity-100","translate-y-0"),setTimeout(()=>{e.classList.remove("opacity-0","-translate-y-5"),e.classList.add("opacity-100","translate-y-0")},50)),t&&(t.classList.remove("hidden"),t.classList.remove("opacity-0","translate-y-5"),t.classList.add("opacity-100","translate-y-0")),a&&a.classList.remove("star-map-highlighted")}async function Oe(e=!1){const t=document.getElementById("starMapCanvas"),a=document.getElementById("starMapInfo");if(!t)return;const o=window.scrollY||window.pageYOffset,s=t.getContext("2d"),i=window.innerWidth,n=window.innerHeight;t.style.position="absolute",t.style.top="0",t.style.left="0",t.style.width="100%",t.style.height="100%",t.style.zIndex="1",t.style.margin="0",t.style.padding="0",t.width=i,t.height=n,s.clearRect(0,0,i,n),requestAnimationFrame(()=>{o!==(window.scrollY||window.pageYOffset)&&window.scrollTo(0,o)});const l=await _e(L.latitude,L.longitude,L.date).catch(()=>Ie(L.latitude,L.date)),d=rt(L.time,l.condition||"Clear"),[m,y]=L.time.split(":").map(Number),h=m+y/60,g=h>=7&&h<15.5,u=h>=15.5&&h<18,b=h>=18&&h<20;if(t&&(t.style.position="absolute",t.style.top="0",t.style.left="0",t.style.width="100%",t.style.height="100%",t.style.zIndex="1"),g||u||b){const r=s.createLinearGradient(0,0,0,n);if(g)l.condition==="Clear"?(r.addColorStop(0,"#87CEEB"),r.addColorStop(.5,"#87CEEB"),r.addColorStop(.8,"#B0D4E6"),r.addColorStop(1,"#C8E0F0")):l.condition==="Clouds"?(r.addColorStop(0,"#B0C4DE"),r.addColorStop(.5,"#B8C8E0"),r.addColorStop(.8,"#C0D0E0"),r.addColorStop(1,"#C8D8E8")):(r.addColorStop(0,"#708090"),r.addColorStop(.5,"#788898"),r.addColorStop(.8,"#8898A8"),r.addColorStop(1,"#98A8B8"));else if(u){const p=(h-15.5)/2.5,f=(w,T,B)=>{const C=w.replace("#",""),P=T.replace("#",""),X=parseInt(C.substr(0,2),16),ne=parseInt(C.substr(2,2),16),ie=parseInt(C.substr(4,2),16),he=parseInt(P.substr(0,2),16),le=parseInt(P.substr(2,2),16),re=parseInt(P.substr(4,2),16),O=Math.round(X+(he-X)*B),ye=Math.round(ne+(le-ne)*B),de=Math.round(ie+(re-ie)*B);return`#${O.toString(16).padStart(2,"0")}${ye.toString(16).padStart(2,"0")}${de.toString(16).padStart(2,"0")}`};l.condition==="Clear"?(r.addColorStop(0,f("#87CEEB","#FF8C42",p)),r.addColorStop(.5,f("#B0D4E6","#FF7F50",p)),r.addColorStop(.8,f("#B0D4E6","#FF6347",p)),r.addColorStop(1,f("#C8E0F0","#FF6B6B",p))):l.condition==="Clouds"?(r.addColorStop(0,f("#B0C4DE","#FFA07A",p)),r.addColorStop(.5,f("#B8C8E0","#FF8C69",p)),r.addColorStop(.8,f("#C0D0E0","#A0522D",p)),r.addColorStop(1,f("#C8D8E8","#CD5C5C",p))):(r.addColorStop(0,f("#708090","#D2691E",p)),r.addColorStop(.5,f("#788898","#CD853F",p)),r.addColorStop(.8,f("#8898A8","#8B4513",p)),r.addColorStop(1,f("#98A8B8","#A0522D",p)))}else b&&(l.condition==="Clear"?(r.addColorStop(0,"#FF8C42"),r.addColorStop(.2,"#FF7F50"),r.addColorStop(.4,"#FF6B6B"),r.addColorStop(.6,"#FF6347"),r.addColorStop(.75,"#FF4500"),r.addColorStop(.85,"#DC143C"),r.addColorStop(.95,"#8B0000"),r.addColorStop(1,"#6B0000")):l.condition==="Clouds"?(r.addColorStop(0,"#FFA07A"),r.addColorStop(.3,"#FF8C69"),r.addColorStop(.5,"#CD5C5C"),r.addColorStop(.7,"#A0522D"),r.addColorStop(.85,"#8B4513"),r.addColorStop(1,"#654321")):(r.addColorStop(0,"#D2691E"),r.addColorStop(.3,"#CD853F"),r.addColorStop(.5,"#A0522D"),r.addColorStop(.7,"#8B4513"),r.addColorStop(.85,"#654321"),r.addColorStop(1,"#4B2C1A")));s.fillStyle=r,s.fillRect(0,0,i,n)}else{s.fillStyle=d.base,s.fillRect(0,0,i,n);const r=s.createRadialGradient(i/2,n/2,0,i/2,n/2,Math.max(i,n));d.gradient.forEach(({stop:p,color:f})=>{r.addColorStop(p,f)}),s.fillStyle=r,s.fillRect(0,0,i,n)}const E=document.querySelector(".star-map-overlay");if(E&&(g?E.classList.remove("night-mode"):E.classList.add("night-mode")),h>=7&&h<18&&l.condition==="Clear"&&dt(s,i,n,h),h>=7&&h<20&&l.condition==="Rain"&&Ee(s,i,n),h>=7&&h<20){let r=function(){if(ee&&q){const[p,f]=L.time.split(":").map(Number),w=p+f/60;q.hour=w,q.isDay=w>=7&&w<18,q.isDusk=w>=18&&w<20,Re(ee,q.width,q.height,q.weatherCondition,!0),q.weatherCondition==="Rain"&&Ee(ee,q.width,q.height),j=requestAnimationFrame(r)}};j&&cancelAnimationFrame(j),me=Date.now(),ee=s,q={width:i,height:n,condition:l.condition||"Clear",isDay:!0,weatherCondition:l.condition||"Clear"},Re(s,i,n,l.condition||"Clear",!1),l.condition==="Rain"&&Ee(s,i,n),j=requestAnimationFrame(r)}else j&&(cancelAnimationFrame(j),j=null),ee=null,q=null;function S(r,p,f,w,T){const B=f*Math.PI/180,C=p*Math.PI/180,[P,X,ne]=L.date.split("-").map(Number),[ie,he]=L.time.split(":").map(Number),le=ie+he/60,re=Math.floor((14-X)/12),O=P+4800-re,ye=X+12*re-3;let de=ne+Math.floor((153*ye+2)/5)+365*O+Math.floor(O/4)-Math.floor(O/100)+Math.floor(O/400)-32045;de+=le/24-.5;let H=(18.697374558+24.06570982441908*(de-2451545))%24;H<0&&(H+=24),H=(H+le*1.00273790935)%24,H<0&&(H+=24);let ve=(H+w/15)%24;ve<0&&(ve+=24);let U=(ve-r/15)*Math.PI/12;for(;U>Math.PI;)U-=2*Math.PI;for(;U<-Math.PI;)U+=2*Math.PI;const Qe=Math.sin(B)*Math.sin(C)+Math.cos(B)*Math.cos(C)*Math.cos(U),Z=Math.asin(Math.max(-1,Math.min(1,Qe)));if(Z<=0)return{x:0,y:0,visible:!1};const Xe=(Math.sin(C)-Math.sin(B)*Math.sin(Z))/(Math.cos(B)*Math.cos(Z));let ce=Math.acos(Math.max(-1,Math.min(1,Xe)));Math.sin(U)>0&&(ce=2*Math.PI-ce);const ze=(Math.PI/2-Z)/(Math.PI/2)*Math.min(i,n)/2,be=i/2+ze*Math.sin(ce),xe=n/2-ze*Math.cos(ce);return{x:be,y:xe,visible:Z>0&&be>=0&&be<=i&&xe>=0&&xe<=n}}const c=[];lt.forEach(r=>{const p=S(r.ra,r.dec,L.latitude,L.longitude,L.date);p.visible&&p.x>=0&&p.x<=i&&p.y>=0&&p.y<=n&&c.push({...r,...p})}),c.sort((r,p)=>r.mag-p.mag);const x=ut(c,L.date);if(c.length>0){const r=c.reduce((C,P)=>C+P.x,0),p=c.reduce((C,P)=>C+P.y,0),f=r/c.length,w=p/c.length,T=i/2-f,B=n/2-w;c.forEach(C=>{C.x+=T,C.y+=B})}const v=e?2.5:1,M=e?1.4:.7,z=e?5:3,A=e?30:50,k=d.starsVisible||e||!g&&!b;k&&c.forEach((r,p)=>{setTimeout(()=>{const f=Math.max(1,3-r.mag/2)*v,w=Math.max(.3,1-(r.mag+1)/5),T=Math.min(.8,w*M),B=s.createRadialGradient(r.x,r.y,0,r.x,r.y,f*z);e?(B.addColorStop(0,`rgba(255, 255, 255, ${T*.5})`),B.addColorStop(.5,`rgba(255, 255, 255, ${T*.2})`),B.addColorStop(1,"rgba(255, 255, 255, 0)")):(B.addColorStop(0,`rgba(255, 255, 255, ${T*.3})`),B.addColorStop(1,"rgba(255, 255, 255, 0)")),s.fillStyle=B,s.beginPath(),s.arc(r.x,r.y,f*z,0,Math.PI*2),s.fill(),s.fillStyle=`rgba(255, 255, 255, ${T*.8})`,s.beginPath(),s.arc(r.x,r.y,f,0,Math.PI*2),s.fill(),e&&(s.fillStyle=`rgba(255, 255, 255, ${Math.min(.9,T*1.2)})`,s.beginPath(),s.arc(r.x,r.y,f*.5,0,Math.PI*2),s.fill())},p*A)});const I=e&&k?300:k?200:0,F=c.length*A;for(let r=0;r<I;r++)setTimeout(()=>{const p=Math.random()*i,f=Math.random()*n,w=Math.random()*.4,T=e?w*1.2:w*.8,B=Math.random()*1.5,C=e?B*1.3:B;if(s.fillStyle=`rgba(255, 255, 255, ${Math.min(.6,T)})`,s.beginPath(),s.arc(p,f,C,0,Math.PI*2),s.fill(),e&&T>.2){const P=s.createRadialGradient(p,f,0,p,f,C*2);P.addColorStop(0,`rgba(255, 255, 255, ${T*.2})`),P.addColorStop(1,"rgba(255, 255, 255, 0)"),s.fillStyle=P,s.beginPath(),s.arc(p,f,C*2,0,Math.PI*2),s.fill()}},F+r*8);if(a&&e)a.classList.remove("hidden"),_e(L.latitude,L.longitude,L.date).then(r=>{setTimeout(()=>{let p=`
        ...
        `;x&&(p+=`
          ...
          `),p+="</div>",a&&(a.innerHTML=p,a.style.opacity="0",a.style.transition="opacity 1s ease-in",setTimeout(()=>{a.style.opacity="1"},100));const f=document.getElementById("starMapInfoMobileContent"),w=document.getElementById("starMapInfoMobile"),T=document.getElementById("starMapInfoToggle");if(f&&w){const B=p.replace(/font-size:\s*1\.125rem/g,"font-size: 1rem").replace(/font-size:\s*0\.875rem/g,"font-size: 0.8125rem").replace(/padding:\s*2\.5rem/g,"padding: 2rem").replace(/margin-bottom:\s*1\.5rem/g,"margin-bottom: 1.25rem").replace(/margin-bottom:\s*1\.25rem/g,"margin-bottom: 1rem");if(f.innerHTML=B,T&&window.innerWidth<768){const P=document.getElementById("starMapInfoToggleIcon");T.style.display="block",P&&(P.textContent="←",P.classList.add("animate-pulse"))}const C=document.getElementById("starMapInfoCloseBtn");if(C){const P=C.cloneNode(!0);C.parentNode.replaceChild(P,C),P.addEventListener("click",Le),P.style.opacity="1",P.style.pointerEvents="auto"}}},1e3)}).catch(()=>{setTimeout(()=>{let r=`
          <div style="background: rgba(0, 0, 0, 0.4); backdrop-filter: blur(12px); border-radius: 1rem; padding: 2.5rem; border: 1px solid rgba(255, 255, 255, 0.1); box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.5); line-height: 1.8;">
            <p style="color: white; font-size: 1.125rem; font-weight: 600; margin-bottom: 1.5rem; text-shadow: 2px 2px 10px rgba(0,0,0,0.5);">
              ${L.city}
            </p>
    ...
    `,e.appendChild(o),setTimeout(()=>{o.style.opacity="1",o.style.transform="translateY(0)"},100+a*200)}))}function St(){const e=document.getElementById("loveReasonText"),t=document.getElementById("nextReasonBtn");if(!e||!t)return;const a=t.cloneNode(!0);t.parentNode.replaceChild(a,t),ae=We(Ae),te=0,e.textContent=ae[0],e.style.opacity="0",e.style.transform="translateY(20px)",e.style.transition="opacity 0.6s ease-in, transform 0.6s ease-out",setTimeout(()=>{e.style.opacity="1",e.style.transform="translateY(0)"},300);const o=document.getElementById("nextReasonBtn");o&&o.addEventListener("click",It)}function It(){const e=document.getElementById("loveReasonText");e&&(e.style.opacity="0",e.style.transform="translateY(-20px)",setTimeout(()=>{te=(te+1)%ae.length,te===0&&(ae=We(Ae)),e.textContent=ae[te],e.style.transform="translateY(20px)",setTimeout(()=>{e.style.opacity="1",e.style.transform="translateY(0)"},50)},300))}function Lt(){const e=new Date("2025-06-25"),t=new Date;e.setHours(0,0,0,0),t.setHours(0,0,0,0);const a=t-e;return Math.floor(a/(1e3*60*60*24))}function Tt(){const e=document.getElementById("daysNumber"),t=document.getElementById("daysHeartContainer"),a=document.querySelector(".heart-path"),o=document.querySelector(".heart-svg");if(!e||!t){console.error("Elementos do slide de dias juntos não encontrados");return}t.style.opacity="0",t.style.transform="scale(0.5)",t.style.transition="none",a&&(a.style.transform="scale(0)",a.style.transition="none"),t.offsetWidth,setTimeout(()=>{t.style.transition="opacity 1s ease-out, transform 1s cubic-bezier(0.34, 1.56, 0.64, 1)",t.style.opacity="1",t.style.transform="scale(1)",a&&(a.style.transition="transform 0.8s cubic-bezier(0.34, 1.56, 0.64, 1)",a.style.transform="scale(1)");const s=Lt();s>=0?Pt(e,0,s,2e3):e.textContent="0"},300),o&&setTimeout(()=>{o.style.animation="heartPulse 2s ease-in-out infinite"},1500)}function Pt(e,t,a,o){const s=performance.now(),i=a-t;function n(l){const d=l-s,m=Math.min(d/o,1),y=1-Math.pow(1-m,3),h=Math.floor(t+i*y);e.textContent=h,m<1?requestAnimationFrame(n):e.textContent=a}requestAnimationFrame(n)}let D=null,Te=!1;window.showProposal=function(){const e=document.getElementById("proposalButtonContainer"),t=document.getElementById("proposalQuestionContainer"),a=document.getElementById("pulsingHeart");if(!e||!t){console.error("Elementos não encontrados");return}e.style.opacity="0",e.style.transition="opacity 0.5s ease-out",e.style.pointerEvents="none",setTimeout(()=>{t.style.opacity="1",t.style.pointerEvents="auto",t.style.transition="opacity 0.8s ease-in",a&&a.classList.add("pulse-animation"),qt()},500)};window.handleYesProposal=function(){zt();const e=document.getElementById("proposalYesBtn");if(e&&(e.style.transform="scale(1.2)",setTimeout(()=>{e.style.transform="scale(1)"},300)),!Te){Te=!0;const t=document.getElementById("proposalNoBtn");t&&(t.style.opacity="0",t.style.pointerEvents="none",t.style.transition="opacity 0.5s ease-out")}};window.handleNoProposal=function(){const e=document.getElementById("proposalNoBtn");if(!e||!document.querySelector('[data-slide="8"]'))return;if(!D){const c=e.getBoundingClientRect(),x=window.getComputedStyle(e),v=e.querySelector("span"),M=v?window.getComputedStyle(v):null;D={width:c.width,height:c.height,fontSize:parseFloat(x.fontSize)||18,paddingTop:parseFloat(x.paddingTop)||20,paddingRight:parseFloat(x.paddingRight)||40,paddingBottom:parseFloat(x.paddingBottom)||20,paddingLeft:parseFloat(x.paddingLeft)||40,spanPaddingX:M&&parseFloat(M.paddingLeft)||8,spanPaddingY:M&&parseFloat(M.paddingTop)||4,borderRadius:x.borderRadius||"9999px"}}const t=document.getElementById("proposalButtons");t&&e.parentNode===t&&(e.style.position="fixed",document.body.appendChild(e));const a=window.innerWidth,o=window.innerHeight,s=.5+Math.random()*.5,i=D.width*s,n=D.height*s;e.style.width=i+"px",e.style.height=n+"px",e.style.minWidth="auto",e.style.minHeight="auto",e.style.display="flex",e.style.alignItems="center",e.style.justifyContent="center",e.style.textAlign="center";const l=Math.min(i,n),d=.1+Math.random()*.4,m=l*d;e.style.borderRadius=m+"px";const y=.15+Math.random()*.85;e.style.opacity=y.toString(),e.style.fontSize=D.fontSize*s+"px",e.style.paddingTop=D.paddingTop*s+"px",e.style.paddingRight=D.paddingRight*s+"px",e.style.paddingBottom=D.paddingBottom*s+"px",e.style.paddingLeft=D.paddingLeft*s+"px";const h=e.querySelector("span");h&&(h.style.padding=`${D.spanPaddingY*s}px ${D.spanPaddingX*s}px`);const g=20,u=g,b=Math.max(g,a-i-g),E=g,S=Math.max(g,o-n-g);if(b>u&&S>E){const c=Math.random()*(b-u)+u,x=Math.random()*(S-E)+E;e.style.left=c+"px",e.style.top=x+"px",e.style.right="auto",e.style.bottom="auto",e.style.transform="none"}else e.style.left="50%",e.style.top="50%",e.style.right="auto",e.style.bottom="auto",e.style.transform="translate(-50%, -50%)";e.style.transition="all 0.3s ease-out",e.style.zIndex="1000",e.style.pointerEvents="auto",setTimeout(()=>{e.style.left==="50%"&&e.style.top==="50%"?(e.style.transform="translate(-50%, -50%) scale(0.95)",setTimeout(()=>{e.style.transform="translate(-50%, -50%)"},150)):(e.style.transform="scale(0.95)",setTimeout(()=>{e.style.transform="none"},150))},10)};function At(){const e=document.getElementById("proposalButtonContainer"),t=document.getElementById("proposalQuestionContainer"),a=document.getElementById("proposalNoBtn");if(e&&(e.style.opacity="1",e.style.pointerEvents="auto"),t&&(t.style.opacity="0",t.style.pointerEvents="none"),D=null,Te=!1,a){a.style.position="static",a.style.transform="none",a.style.left="auto",a.style.top="auto",a.style.right="auto",a.style.bottom="auto",a.style.zIndex="auto",a.style.width="auto",a.style.height="auto",a.style.fontSize="",a.style.padding="",a.style.transform="none",a.style.transformOrigin="",a.style.display="",a.style.alignItems="",a.style.justifyContent="",a.style.textAlign="",a.style.borderRadius="",a.style.opacity="",a.style.pointerEvents="";const o=a.querySelector("span");o&&(o.style.padding="");const s=document.getElementById("proposalButtons");s&&(a.parentNode===document.body||a.parentNode!==s)&&s.appendChild(a)}}function zt(){const e=document.getElementById("fireworksContainer");if(!e)return;const t=["💖","💕","💗","💝","💞","💓","💘","💟","❤️","🧡","💛","💚","💙","💜","🖤","🤍","🤎","🎁","🎀","🎂","🍰","🌹","🌷","🌺","🌸","💐","🌻","🎉","🎊","✨","⭐","🌟","💫","🎈","🎆","🎇","🏆"],a=50;for(let o=0;o<a;o++){const s=document.createElement("div");s.textContent=t[Math.floor(Math.random()*t.length)],s.style.position="absolute",s.style.fontSize="2rem",s.style.left="50%",s.style.top="50%",s.style.pointerEvents="none",s.style.zIndex="9999";const i=Math.PI*2*o/a,n=200+Math.random()*100,l=1.5+Math.random()*.5;s.style.transform="translate(-50%, -50%)",s.style.transition=`all ${l}s ease-out`,e.appendChild(s),setTimeout(()=>{const d=Math.cos(i)*n,m=Math.sin(i)*n;s.style.transform=`translate(calc(-50% + ${d}px), calc(-50% + ${m}px))`,s.style.opacity="0"},10),setTimeout(()=>{s.remove()},l*1e3+100)}}function kt(){Ye(0)}function qt(){const e=["#ff6b9d","#c44569","#ffd93d","#ff6b9d","#f8b500"];for(let t=0;t<50;t++){const a=document.createElement("div");a.className="light-confetti",a.style.position="fixed",a.style.width="8px",a.style.height="8px",a.style.left=Math.random()*100+"%",a.style.top="-10px",a.style.backgroundColor=e[Math.floor(Math.random()*e.length)],a.style.borderRadius="50%",a.style.pointerEvents="none",a.style.zIndex="9999",a.style.animation=`lightConfettiFall ${2+Math.random()*2}s linear forwards`,a.style.animationDelay=Math.random()*.3+"s",document.body.appendChild(a),setTimeout(()=>{a.remove()},5e3)}}let fe=!1,J=null;function _t(){J&&clearTimeout(J);const e=document.getElementById("finalMessageText");e&&_===9&&(e.textContent="",fe=!1,J=setTimeout(()=>{_===9&&(fe=!0,Je(e,"Espero que guarde esse presente como algo bom na sua memória e que algum dia você possa contar aos nosso filhos a história de como te pedi em namoro. Te amo em todas as vidas 💜",0))},1e3))}function Je(e,t,a){_!==9||!fe||a<t.length&&(e.textContent=t.substring(0,a+1),setTimeout(()=>{Je(e,t,a+1)},60))}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ke):ke();
